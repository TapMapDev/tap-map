...
class PointDetail {
  ...
  final List<PointDetail>? polygonChildren;
  ...
  factory PointDetail.fromJson(Map<String, dynamic> json) {
    ...
    return PointDetail(
      ...
      polygonChildren: (json['polygon_children'] as List<dynamic>? ?? [])
          .map((e) => PointDetail.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  factory PointProperties.fromJson(Map<String, dynamic> json) {
    return PointProperties(
      ...
      workingHours: json['working_hours'] != null
          ...
          : null,
      priceList: (json['price_list'] as List<dynamic>?)?.map((e) => Product.fromJson(e as Map<String, dynamic>)).toList(),
